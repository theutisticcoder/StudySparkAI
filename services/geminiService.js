...
export const generateApPlan = async subject => {
  try {
    const response = await ai.models.generateContent({
      model: "gemini-2.5-flash",
...
export const generatePracticeExam = async subject => {
  try {
...
export const gradePracticeExam = async (exam, answers) => {
  try {
